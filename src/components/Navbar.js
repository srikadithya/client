      ...
      <React.Fragment>
        <AppBar sx={{ backgroundColor: 'white', display: 'flex', alignItems: 'center', boxShadow: 'none' }}>
          ...
          <Tabs centered sx={{ display: { xs: 'none', md: 'flex' } }}>
            ...
            <Tab style={{ ...tabStyle }} label='Adopt a pet' disableRipple disableFocusRipple />
            <Tab style={{ ...tabStyle }} label='About PLC' disableRipple disableFocusRipple />
            <Tab style={{ ...tabStyle }} label='Contact' component={Link} to="/contact" disableRipple disableFocusRipple />
            <Tab style={{ ...tabStyle }} label='Help' disableRipple disableFocusRipple />
        ...
        >
          ...
          <MenuItem onClick={handleMenuClose}>Adopt a pet</MenuItem>
          <MenuItem onClick={handleMenuClose}>About PLC</MenuItem>
